...
const requestData = {
  ...
  messages: [
    ...
    },
    {
      role: "system",
      content:
        "you are an ai tool that creates html pages from the user's prompt. you don't add any explanations or additional text, only the html code. don't add any src to img tags. add modern styling to the page. add css and javascript to the same file. link to cdn libraries if needed.",
    },
  ],
};

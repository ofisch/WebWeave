const frontPageStyle = {
  ...
  headerContent: "ease-in-out duration-300 grid grid-cols-6 gap-4",
  headerContentContrast:
    "ease-in-out duration-300 grid grid-cols-6 gap-4 bg-gray-100 rounded-b-lg",
  headerH1: "text-4xl text-left text-action font-sourcecode p-4",
  headerContents:
    "col-start-2 col-span-4 ml-4 items-center text-left flex gap-10 p-4 ",
  /*   headerContentsContrast:
    "ease-in-out duration-300 col-start-2 col-span-4 ml-4 items-center text-left flex gap-10 bg-gray-100 w-fit px-4 rounded-b-lg p-4", */
  headerA:
  ...
  headerButtons: "space-x-4 justify-end col-start-6 p-4",
  ...
  moveButton: "text-white bg-action px-4 py-2 m-2 rounded-full shadow-md",

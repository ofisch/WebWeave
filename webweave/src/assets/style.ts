const style = {
  ...
  advSettingsToggleOff:
    "ease-in-out duration-300 text-action scale-150 justify-self-end col-span-1",
  advSettingsText: "text-action justify-self-start col-span-1",
  advSettingsToggleOn:
    "ease-in-out duration-300 text-gray-500 scale-150 justify-self-end col-span-1",
};
